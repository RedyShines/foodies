...
class Menu:
    ...
    def __init__(self, parent):
        ...
        self.main_menu =[
            ...
            ["Sashimi", "3 each of raw Salmon, Tuna, and Squid", PhotoImage(file="internals/foodies/食べ物0003.gif"), 8.60]
        ]
        ...
        self.mainlbl = Label(self.mainframe, text="Main Menu", bg="#fff2e0")
        ...
        self.sidelbl = Label(self.sideframe, text="Side Menu", bg="#fff2e0")
        ...
        # The contents of the side frame
        self.dessertlbl = Label(self.dessertframe, text="Dessert Menu", bg="#fff2e0")
        ...
        # The contents of the side frame
        self.drinklbl = Label(self.drinkframe, text="Drink Menu", bg="#fff2e0")
    ...
    def calculate_fee(self):
        ...
        menu_list = self.current_tab[4]
        item = menu_list[self.target][0]
        price = menu_list[self.target][3]
    ...
    def show_frame(self, frame):
        '''Shows a frame'''
        #assign a frame's menu
        if frame == self.breakfastframe:
            self.current_tab = self.list[0]
        elif frame == self.mainframe:
            self.current_tab = self.list[1]
        elif frame == self.sideframe:
            self.current_tab = self.list[2]
        elif frame == self.dessertframe:
            self.current_tab = self.list[3]
        elif frame == self.drinkframe:
            self.current_tab = self.list[4]
